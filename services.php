		...
		<div class="services">
			...
			<div class="w3ls_service_grids">
				<div class="col-md-5 w3ls_service_grid_left">
					<h4>Meeting Everyday needs</h4>
					<p>Our aim is to satisfy your online concerns / needs, delivering very sought after items with top notch quality....and if you are not pleased with our items, we will refund you a 100% of the costs.</p>
				</div>
...
<!---728x90--->
			<div class="w3ls_service_grids1">
				...
				<div class="col-md-6 w3ls_service_grids1_right">
					<ul>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>100% money back guaranteed.</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Fresh foods and groceries.</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Door to door delivery.</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>24hrs customer support.</li>
						<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Extra discount gotten for multiple items bought.</li>	
					</ul>
