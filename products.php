			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>ACE STORE</h4>
							<p>Loads of affordable items at the best quality.</p>
						</div>
					</div>
					<h4>Utensils</h4>
					<ol>
						<li>Pots and Pans</li>
						<li>Cutleries</li>
						<li>Table mats and table covers</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						<!-- <img src="images/14.jpg" alt=" " class="img-responsive" /> -->
						<img src="images/naturalHair.jpg" alt=" " class="img-responsive" />
						<div class="mask">
							<h4>ACE STORE</h4>
							<p>Loads of affordable items at the best quality.</p></div>
					</div>
					<h4>Hair Care</h4>
					<ol>
						<li>Shampoo and conditioners</li>
						<li>Relaxers and hair straighteners</li>
						<li>Anti-dandruff creams</li>
					</ol>
				</div>
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
					...
					<h4>Cookies</h4>
					<ol>
						<li>Branded cookies</li>
						<li>Cabin and Nasco</li>
