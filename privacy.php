...
<!---728x90--->
				<div class="banner-bottom-grid1 privacy1-grid">
					<ul>
						...
						<li>Profile <span>All profiles of our users and shoppers are kept in a session mode, thus it terminates after you log out.</span></li>
					</ul>
					<ul>
						<li><i class="glyphicon glyphicon-search" aria-hidden="true"></i></li>
						<li>Search <span>Your search history will always be secured. Nothing to worry about.</span></li>
					</ul>
<!---728x90--->
			...
			<div class="privacy1">
				...
				<div class="banner-bottom-grid1 privacy2-grid">
					<div class="privacy2-grid1">
						<h4>Please refer to our copyright policies.</h4>
						<p>see above.<div class="privacy2-grid1-sub">
							</div></p>
